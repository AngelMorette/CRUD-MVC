...
namespace ProjetoWeb.Models
{
        public class ContatoModel : IDisposable
        {
            ...
            public ContatoModel()
            {
                string strConn = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename= C:\Users\est_dsi\source\repositorio\crudMedium\ProjetoWeb\ProjetoWeb\App_Data\BDContato.mdf;Integrated Security=True";
